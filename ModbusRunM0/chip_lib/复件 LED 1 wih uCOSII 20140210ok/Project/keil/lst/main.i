...
int main(void)
{
	...
	((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )))->PMD = ((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )))->PMD & ~((0x3UL) << ((1)<<1))) | ((0x1UL) << ((1)<<1)));
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x200)+(0x20*(3))) + ((6)<<2)))) = 0;
	usart1_init(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)));
	OSInit();	
	
	OSTaskCreateExt((void (*)(void *)) AppTaskStart,             
				(void           *) 0,
				(OS_STK         *)&AppTaskStartStk[30 - 1],
				(INT8U           ) 4,
				(INT16U          ) 4,
