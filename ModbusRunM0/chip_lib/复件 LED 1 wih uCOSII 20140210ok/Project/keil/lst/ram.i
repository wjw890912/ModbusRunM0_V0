...
OS_STK          AppTaskStartStk[30];
OS_STK          AppTaskTestStk[30];
OS_STK          AppTaskTest1Stk[30];
...
void  AppTaskStart (void *p_arg)
{
	  ...
	  for(i = 0; i < 3; i++)
	  {
		...
		OSTaskCreateExt((void (*)(void *)) AppTest,             
				(void           *) 0,
				(OS_STK         *)&AppTaskTestStk[30 - 1],
				(INT8U           ) 5,
				(INT16U          ) 5,
				(OS_STK         *)&AppTaskTestStk[0],
				(INT32U          ) 30,
				(void           *) 0,
				(INT16U          )(0x0001u | 0x0002u));


    OSTaskNameSet((INT8U     )5,
                  (INT8U    *)"Start_Test",
                  (INT8U    *)&os_err);

	
		OSTaskCreateExt((void (*)(void *)) AppTest1,             
				(void           *) 0,
				(OS_STK         *)&AppTaskTest1Stk[30 - 1],
				(INT8U           ) 6,
				(INT16U          ) 6,
    ...
    OSTaskNameSet((INT8U     )6,
                  (INT8U    *)"Start_Test1",
                  (INT8U    *)&os_err);

	

    OS_CPU_SysTickInit(12000);   
